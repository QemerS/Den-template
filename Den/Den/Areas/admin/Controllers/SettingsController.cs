...
namespace Den.Areas.admin.Controllers
{
    [Area("admin")]
    public class SettingsController : Controller
    {
        private readonly DenContext _context;

        public SettingsController(DenContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Address,Phone,Mail,ImgLink")] Setting setting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Address,Phone,Mail,ImgLink")] Setting setting)
        {
            if (id != setting.ID)
            {
                return NotFound();
